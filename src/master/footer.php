        ...
        <div class="row flex flex-col md:flex-row lg:gap-50 md:gap-30 gap-5">
            <nav>
                <ul class="flex flex-col  text-sm font-medium text-[18px] ">
                    ...
                    <li class="reveal-text"><a href="tel:+8447695038"
                            class="hover:underline hover:underline-offset-4 transition-all ">(+91)
                            844 769 5038</a></li>
                </ul>
            </nav>
            <nav>
            ...
            <nav>
                <ul class="flex flex-col  text-sm font-medium text-[18px] ">
                    ...
                    <li class="reveal-text"><a href="https://www.linkedin.com/in/jyotirmay-biswas-1b9b10368"
                            class="hover:underline hover:underline-offset-4 transition-all  ">LinkedIn</a></li>
                    <li class="reveal-text"><a href="https://www.linkedin.com/in/jyotirmay-biswas-1b9b10368"
                            class="hover:underline hover:underline-offset-4 transition-all  ">X</a></li>
                </ul>
            </nav>
        </div>
